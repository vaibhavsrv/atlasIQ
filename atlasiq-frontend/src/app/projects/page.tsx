  ...
  return (
    <main className="container mx-auto px-6 py-16 max-w-6xl flex-grow">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {projects.map((p: any) => (
          <Link href="/simulations" key={p.id}>
            <Card className="bg-white border-neutral-200/60 shadow-sm hover:shadow-md transition-all duration-300 rounded-2xl group cursor-pointer h-full">
